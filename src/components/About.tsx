        ...
        <div className="relative overflow-hidden">
          <div className="flex animate-scroll">
            ...
            {developers.map((developer, index) => (
              <div
                key={`${developer.name}-1`}
                className="flex-shrink-0 w-80 mx-4"
              >
                <div className="bg-gradient-card rounded-2xl p-8 shadow-soft hover:shadow-hover transition-all duration-300 group border border-border">
